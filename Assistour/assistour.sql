...
CREATE TABLE IF NOT EXISTS TYPECONTRAT
 (
   IDTYPECONTRAT INTEGER(4) NOT NULL   ,
...
CREATE TABLE IF NOT EXISTS ETAPE
 (
   IDDS INTEGER(4) NOT NULL  ,
   NUMEROORDRE INTEGER(4) NOT NULL  ,
   IDTT INTEGER(4) NOT NULL,
   IDTRANS INTEGER(4) NOT NULL  ,
...
CREATE TABLE IF NOT EXISTS EFFECTUER
 (
  IDDS INTEGER(4) NOT NULL  ,
  IDTO INTEGER(4) NOT NULL  ,
  PRIMARY KEY (IDDS,IDTO),
  FOREIGN KEY(IDDS) REFERENCES DOSSIERSINISTRE(IDDS),
  FOREIGN KEY(IDTO) REFERENCES TYPEOPERATION(IDTO) 
 )
 comment = "";
...
CREATE TABLE IF NOT EXISTS CONCERNE
 (
  ...
  IDHOT INTEGER(4) NOT NULL  ,
  IDCO INTEGER(4) NOT NULL  ,
  PRIMARY KEY (IDDS,IDHOT),
  FOREIGN KEY(IDDS) REFERENCES DOSSIERSINISTRE(IDDS),
  FOREIGN KEY(IDHOT) REFERENCES HOTEL(IDHOT),
  FOREIGN KEY(IDCO) REFERENCES COULEUR(IDCO) 
